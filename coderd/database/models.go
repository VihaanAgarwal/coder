...
type Chat struct {
	...
	CompactionRequestedByAPIKeyID sql.NullString          `db:"compaction_requested_by_api_key_id" json:"compaction_requested_by_api_key_id"`
}
...
type ChatTable struct {
	...
	CompactionRequestedAt sql.NullTime `db:"compaction_requested_at" json:"compaction_requested_at"`
	// API key that requested the manual compaction. The compaction turn inserts no user message, so the worker falls back to this key for AI Gateway attribution when the prior history carries none. Cleared together with compaction_requested_at.
	CompactionRequestedByAPIKeyID sql.NullString `db:"compaction_requested_by_api_key_id" json:"compaction_requested_by_api_key_id"`
}
